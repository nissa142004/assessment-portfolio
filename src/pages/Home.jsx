        ...
        <main className="flex-1 flex flex-col lg:flex-row items-center justify-center gap-10 px-6 md:px-12 pb-10">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-5">
              This portfolio brings together my work, reflections, and activities
              from the Professional Skills module. It covers employability skills,
              CV and interview prep, portfolio building, project proposals, and more.
            </p>
